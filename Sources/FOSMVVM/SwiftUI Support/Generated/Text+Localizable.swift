...
public extension Text {
    /// Localizable-accepting form of SwiftUI's `Text.accessibilityLabel(_:)`.
    ///
    /// ## Example
    ///
    /// ```swift
    ...
    /// Text.accessibilityLabel(_:defaultValue:)
    /// ```
    ///
    /// - Parameters:
    ///   - localizable: The ``Localizable`` to display.
    ///   - defaultValue: Fallback text used if localization did not complete.
    nonisolated func accessibilityLabel(_ localizable: some Localizable, defaultValue: String? = nil) -> Text {

...
struct EmitterTests {
    ...
    @Test func emitsLocalOnlyFileSet() throws {
        ...
        let expected = [
            ...
            "Sources/PalettePress/Assets.xcassets/Contents.json",
            "Sources/PalettePress/Assets.xcassets/AccentColor.colorset/Contents.json",
            "Sources/PalettePress/Assets.xcassets/AppIcon.appiconset/Contents.json",

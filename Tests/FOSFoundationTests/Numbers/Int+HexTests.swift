...
struct IntHexTests {
    ...
    func uint64HexString(tuple: (value: UInt64, style: HexadecimalPrefixStyle, result: String)) {
    ...
    func int64HexString(tuple: (value: Int64, style: HexadecimalPrefixStyle, result: String)) {
        #expect(tuple.value.hexString(prefixStyle: tuple.style) == tuple.result)
    }
    ...
    func uintHexString(tuple: (value: UInt, style: HexadecimalPrefixStyle, result: String)) {
        #expect(tuple.value.hexString(prefixStyle: tuple.style) == tuple.result)
    }
    ...
    func intHexString(tuple: (value: Int, style: HexadecimalPrefixStyle, result: String)) {
        #expect(tuple.value.hexString(prefixStyle: tuple.style) == tuple.result)
    }
}
